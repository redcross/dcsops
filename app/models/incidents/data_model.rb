class Incidents::DataModel < ActiveRecord::Base
  ...
  has_paper_trail skip: [:cac_number], meta: {root_type: ->obj{obj.incident_id && 'Incidents::Incident'}, root_id: ->(obj){obj.incident_id}, chapter_id: ->(obj){obj.try(:chapter_id) || obj.incident.try(:chapter_id)} }
