...
describe "incidents/incidents/new" do
  before(:each) do
    assign(:incidents_incident, stub_model(Incidents::Incident,
      :chapter => nil,
      :county => nil,
  ...
  it "renders new incidents_incident form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", incidents_incidents_path, "post" do
