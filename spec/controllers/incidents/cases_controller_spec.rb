...
describe Incidents::CasesController do
  ...
  describe "#edit" do
    ...
    it "renders normally" do
      get :edit, {incident_id: incident.to_param, id: kase.to_param}
      response.should render_template('edit')
      response.should render_template(layout: 'application')
    end

    it "renders without layout when xhr" do
      xhr :get, :edit, {incident_id: incident.to_param, id: kase.to_param}
      response.should render_template('edit')
      response.should render_template(layout: nil)
    end
  ...
  describe '#create' do
    ...
    context "when HTML" do
      ...
      it "renders new with layout when invalid" do
        post :create, {incident_id: incident.to_param, :incidents_case => invalid_attributes}
    ...
    context "when JS" do
      it "triggers the incident page refresh" do
        xhr :post, :create, {incident_id: incident.to_param, :incidents_case => valid_attributes}
        response.should render_template('update')
      end

      it "renders the form within javascript when invalid" do
        xhr :post, :create, {incident_id: incident.to_param, :incidents_case => invalid_attributes}
        response.should render_template('edit')
  ...
  describe '#destroy' do
    ...
    it "destroys the object" do
      expect {
        delete :destroy, {incident_id: incident.to_param, id: kase.to_param}
      }.to change(Incidents::Case, :count).by(-1)
      expect {
        kase.reload
    ...
    it "when JS, triggers the incident page refresh" do
      xhr :delete, :destroy, {incident_id: incident.to_param, id: kase.to_param}
      response.should render_template('update')
    end
  end
