...
describe Incidents::CasesController, :type => :controller do
  ...
  describe "#edit" do
    ...
    it "renders normally" do
      get :edit, params: { incident_id: incident.to_param, chapter_id: incident.chapter.to_param, id: kase.to_param }
      expect(response).to render_template('edit')
      expect(response).to render_template(layout: 'application')
    end

    it "renders without layout when xhr" do
      get :edit, xhr: true, params: {incident_id: incident.to_param, chapter_id: incident.chapter.to_param, id: kase.to_param}
      expect(response).to render_template('edit')
      expect(response).to render_template(layout: nil)
    end
  ...
  describe '#create' do
    it "creates with a valid object" do
      expect {
        post :create, params: { incident_id: incident.to_param, chapter_id: incident.chapter.to_param, :incidents_case => valid_attributes }
    ...
    context "when HTML" do
      ...
      it "renders new with layout when invalid" do
        post :create, params: { incident_id: incident.to_param, chapter_id: incident.chapter.to_param, :incidents_case => invalid_attributes }
    ...
    context "when JS" do
      it "triggers the incident page refresh" do
        post :create, xhr: true, params: {incident_id: incident.to_param, chapter_id: incident.chapter.to_param, :incidents_case => valid_attributes}
        expect(response).to render_template('update')
      end

      it "renders the form within javascript when invalid" do
        post :create, xhr: true, params: {incident_id: incident.to_param, chapter_id: incident.chapter.to_param, :incidents_case => invalid_attributes}
        expect(response).to render_template('edit')
  ...
  describe '#destroy' do
    ...
    it "destroys the object" do
      expect {
        delete :destroy, params: { incident_id: incident.to_param, chapter_id: incident.chapter.to_param, id: kase.to_param }
      }.to change(Incidents::Case, :count).by(-1)
      expect {
        kase.reload
    ...
    it "when JS, triggers the incident page refresh" do
      delete :destroy, xhr: true, params: {incident_id: incident.to_param, chapter_id: incident.chapter.to_param, id: kase.to_param}
      expect(response).to render_template('update')
    end
  end
