...
describe Incidents::IncidentsController, :type => :controller do
  ...
  describe "#show" do
    ...
    it "should succeed with no cas or dat" do
      inc = FactoryGirl.create :incident, chapter: @person.chapter
      get :show, params: { id: inc.to_param, chapter_id: inc.chapter.to_param }
      expect(response).to be_success
    end
    ...
    it "should succeed rendering a partial" do
      get :show, params: { id: inc.to_param, chapter_id: inc.chapter.to_param, partial: 'details' }
  ...
  describe "#close" do
    ...
    it "should succeed with a complete incident" do
      expect {
        post :close, params: { id: complete_incident.to_param, chapter_id: complete_incident.chapter.to_param }
    ...
    it "should not succeed with an incomplete incident" do
      expect {
        post :close, params: { id: raw_incident.to_param, chapter_id: raw_incident.chapter.to_param }
  ...
  describe "#reopen" do
    ...
    it "should succeed" do
      expect {
        post :reopen, params: { id: complete_incident.to_param, chapter_id: complete_incident.chapter.to_param }
        expect(response).to redirect_to("/incidents/#{complete_incident.chapter.to_param}/incidents/#{complete_incident.to_param}")
  ...
  describe "#create" do
    ...
    it "should succeed with valid params in editable mode" do
      @person.chapter.update_attributes incidents_report_editable: true
      expect {
        post :create, params: { incidents_incident: params, chapter_id: @person.chapter.to_param }
  ...
  describe '#activity' do
    ...
    it "should succeed" do
      get :activity, params: { chapter_id: @person.chapter.to_param }
      expect(response).to be_success
    end
  ...
  describe '#resource_changes', versioning: true do
    ...
    it "should provide list of changes to incidents" do
      ...
      get :activity, params: { chapter_id: i.chapter.to_param }
    ...
    it "should show only the changes for the given incident if specified" do
      ...
      get :show, params: { id: i.to_param, chapter_id: i.chapter.to_param }
