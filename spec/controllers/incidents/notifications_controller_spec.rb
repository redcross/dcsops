...
describe Incidents::NotificationsController, :type => :controller do
  ...
  describe '#create' do
    it "creates with a valid object" do
      ...
      expect {
        post :create, params: { incident_id: incident.to_param, chapter_id: incident.chapter.to_param, :incidents_notifications_message => valid_attributes }
    ...
    context "when HTML" do
      ...
      it "renders new with layout when invalid" do
        post :create, params: { incident_id: incident.to_param, chapter_id: incident.chapter.to_param, :incidents_notifications_message => invalid_attributes }
    ...
    context "when JS" do
      it "triggers the incident page refresh" do
        post :create, xhr: true, params: {incident_id: incident.to_param, chapter_id: incident.chapter.to_param, :incidents_notifications_message => valid_attributes}
        expect(response).to render_template('update')
      end

      it "renders the form within javascript when invalid" do
        post :create, xhr: true, params: {incident_id: incident.to_param, chapter_id: incident.chapter.to_param, :incidents_notifications_message => invalid_attributes}
