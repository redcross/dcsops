...
describe Incidents::DatIncidentsController, :type => :controller do
  ...
  describe "#edit" do
    ...
    it "should render under an incident" do
      get :edit, params: { incident_id: @incident.to_param, chapter_id: @incident.chapter.to_param }
    end
    it "should not render standalone" do
      expect {
        get :edit, params: { id: @dat.to_param, chapter_id: @incident.chapter.to_param }
      }.to raise_error
    end
  end
  ...
  context "with an existing incident" do  
    ...
    it "should allow creating" do
      expect {
        post :create, params: { incident_id: @incident.to_param, chapter_id: @incident.chapter.to_param, incidents_dat_incident: create_attrs }
  ...
  context "updating an existing report" do
    ...
    it "should notify the report was filed" do
      ...
      put :update, params: { incident_id: @incident.to_param, chapter_id: @incident.chapter.to_param, incidents_dat_incident: {incident_attributes: {num_adults: 3}} }
      expect(response).to redirect_to(incidents_chapter_incident_path(@incident.chapter, @incident))
    end
  end
end
