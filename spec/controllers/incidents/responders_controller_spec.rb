...
describe Incidents::RespondersController, :type => :controller do
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Incidents::Responder" do
        expect {
          post :create, params: { :incidents_responder_assignment => valid_attributes, incident_id: incident.to_param, chapter_id: incident.chapter.to_param }, session: valid_session
      ...
      it "triggers the assignment mailers with a responding role" do
        ...
        post :create, params: { :incidents_responder_assignment => valid_attributes.merge(role: 'team_lead'), incident_id: incident.to_param, chapter_id: incident.chapter.to_param, send_assignment_sms: true, send_assignment_email: true }, session: valid_session
      end
      ...
      it "triggers the assignment mailers with a non-responding role" do
        ...
        post :create, params: { :incidents_responder_assignment => valid_attributes.merge(role: 'not_available'), incident_id: incident.to_param, chapter_id: incident.chapter.to_param, send_assignment_sms: true, send_assignment_email: true }, session: valid_session
      end
    end
  end
  ...
  describe "GET index" do
    it "should succeed" do
      get :index, params: { incident_id: incident.to_param, chapter_id: incident.chapter.to_param }
  ...
  describe "GET new" do
    ...
    it "should assign the person if given" do
      get :new, params: { incident_id: incident.to_param, chapter_id: incident.chapter.to_param, person_id: person.id }
      expect(response).to be_success
  ...
  describe "POST update_status" do
    ...
    it "fails with an invalid value" do
      expect {
        post :update_status, {incident_id: incident.to_param, chapter_id: incident.chapter.to_param, id: assignment.id, status: 'whatever'}
      }.to_not change{assignment.reload.attributes}
    end
    it "updates dispatched at" do
      expect {
        post :update_status, {incident_id: incident.to_param, chapter_id: incident.chapter.to_param, id: assignment.id, status: 'dispatched'}
