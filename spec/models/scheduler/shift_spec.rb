...
describe Scheduler::Shift, :type => :model do
  ...
  describe "can_sign_up_on_day" do
    it "should be true today" do
      expect(shift.can_sign_up_on_day(date, shift_group)).to be_truthy
    end
    ...
    it "should be false yesterday" do
      expect(shift.can_sign_up_on_day(date-1, shift_group)).to be_falsey
    end
    ...
    it "should be false if the shift is not active" do
      ...
      expect(shift.can_sign_up_on_day(date, shift_group)).to be_falsey
    end
    ...
    it "should be false if max_advance_signup is too soon" do
      ...
      expect(shift.can_sign_up_on_day(date+20, shift_group)).to be_falsey
    end
  ...
  describe "can_remove_on_day" do
    it "should be true today" do
      expect(shift.can_remove_on_day(date, shift_group)).to be_truthy
    end

    it "should be true tomorrow" do
      expect(shift.can_remove_on_day(date+1, shift_group)).to be_truthy
    end

    it "should be false yesterday" do
      expect(shift.can_remove_on_day(date-1, shift_group)).to be_falsey
    end

    it "should be false if the shift has been frozen before" do
      shift.update_attribute :signups_frozen_before, date+1
      expect(shift.can_remove_on_day(date, shift_group)).to be_falsey
    end
