...
ActiveRecord::Schema.define(version: 20130621171031) do
  ...
  create_table "incidents_notifications", force: true do |t|
    t.integer  "person_id"
    t.integer  "county_id"
    t.string   "notification_type"
    t.datetime "created_at"
  ...
  add_index "incidents_notifications", ["county_id"], name: "index_incidents_notifications_on_county_id"
  add_index "incidents_notifications", ["person_id"], name: "index_incidents_notifications_on_person_id"
