class AddNewYorkFieldsToDatIncident < ActiveRecord::Migration
  def change
    ...
    add_column :incidents_dat_incidents, :injury_black, :integer
    add_column :incidents_dat_incidents, :injury_red, :integer
    add_column :incidents_dat_incidents, :injury_yellow, :integer
    ...
    add_column :incidents_dat_incidents, :number_of_alarms, :integer
