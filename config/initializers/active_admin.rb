ActiveAdmin.setup do |config|
  ...
  config.default_namespace = 'scheduler_admin'
  ...
  config.authentication_method = :require_valid_user!
  ...
  #
  # Default:
  config.logout_link_path = :roster_session_path
  ...
  ['scheduler_admin', 'roster_admin'].each do |ns|
    config.namespace ns do |ns_config|
      ns_config.build_menu do |menu|
        ...
        #menu.add label: 'Roster', url: '/roster_admin/regions'
